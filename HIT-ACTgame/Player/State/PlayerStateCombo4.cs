...
public class PlayerStateCombo4 : PlayerStateBase
{
    public override void OnInit()
    {
        base.OnInit();
        playerState = PlayerState.Combo4; //记录状态
        aniName = "Combo4"; //记录动画名
    }

    public override void OnEnter()
    {
        //进入状态 播放对应状态动画
        animator.SetInteger("Combo", 4);
    ...
    public override void OnExcute()
    {
        ...
        if (animator.GetCurrentAnimatorStateInfo(0).normalizedTime > 0.35f &&
            ...
            camera.Shake(0.05f, 6.0f, 0.002f, 0.3f);
    }
